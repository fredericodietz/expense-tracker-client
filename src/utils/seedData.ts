...
const seedData: BillType[] = [
  ...
  createData(6, 'Rent', 12, false, Categories.House, 1200.5),
  createData(7, 'Health insurance', 13, false, Categories.Insurance, 100),
  createData(8, 'Credit card', 20, false, Categories.Shopping, null)
];
